    ...
    const products = [
      {
        name: 'Chanel No. 5',
        slug: 'chanel-no-5',
        description: 'The legendary fragrance that epitomizes timeless elegance. A floral aldehyde composition with notes of ylang-ylang, rose, and sandalwood.',
        price: 150.00,
        comparePrice: 180.00,
        images: [
      ...
      },
      {
        name: 'Dior Sauvage',
        slug: 'dior-sauvage',
        description: 'A radical freshness with a raw, noble character. Calabrian bergamot, Sichuan pepper, and ambroxan create an intensely masculine fragrance.',
        price: 120.00,
        comparePrice: 140.00,
        images: [
      ...
      },
      {
        ...
        description: 'A luxurious and sensual fragrance with black orchid, dark chocolate, and patchouli. Perfect for evening wear.',
        price: 200.00,
        images: [
      ...
      },
      {
        name: 'Creed Aventus',
        slug: 'creed-aventus',
        description: 'The bestselling men\'s fragrance. A sophisticated blend of pineapple, blackcurrant, and oakmoss.',
        price: 350.00,
        images: [
      ...
      },
      {
        ...
        description: 'Captures the memory of a beach walk. Fresh coconut milk, bergamot, and cedar create a breezy summer scent.',
        price: 130.00,
        images: [
      ...
      },
      {
        ...
        description: 'A modern interpretation of the legendary Coco. Fresh orange, elegant rose, and patchouli create an irresistible fragrance.',
        price: 140.00,
        images: [
